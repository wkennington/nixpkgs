{ composableDerivation, fetchurl, pkgconfig, xorg
, freeglut, mesa, libjpeg, zlib, libpng
, cfg ? {}
...
composableDerivation.composableDerivation {} {
  ...
  propagatedBuildInputs = [ xorg.xlibsWrapper xorg.inputproto xorg.libXi freeglut ];
